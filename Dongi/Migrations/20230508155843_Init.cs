    ...
    public partial class Init : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_AppTxs", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_AppTxDetails", x => x.Id);
                    table.ForeignKey(
                        name: "FK_AppTxDetails_AppPersons_PersonId",
                        column: x => x.PersonId,
                        principalTable: "AppPersons",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_AppTxDetails_AppTxs_TxId",
                        column: x => x.TxId,
                        principalTable: "AppTxs",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_AppTxDetails_PersonId",
                table: "AppTxDetails",
                column: "PersonId");

            migrationBuilder.CreateIndex(
                name: "IX_AppTxDetails_TxId",
                table: "AppTxDetails",
                column: "TxId");
