...
{
    [DbContext(typeof(DongiDbContext))]
    partial class DongiDbContextModelSnapshot : ModelSnapshot
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Dongi.Entities.Person", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Dongi.Entities.Tx", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                    ...
                    b.ToTable("AppTxs", (string)null);
                });

            modelBuilder.Entity("Dongi.Entities.TxDetail", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint");
                    ...
                    b.ToTable("AppTxDetails", (string)null);
                });
            ...
            modelBuilder.Entity("Dongi.Entities.TxDetail", b =>
                {
                    b.HasOne("Dongi.Entities.Person", "Person")
                        .WithMany("TxDetails")
                        .HasForeignKey("PersonId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("Dongi.Entities.Tx", "Tx")
                        .WithMany("TxDetails")
                        .HasForeignKey("TxId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
